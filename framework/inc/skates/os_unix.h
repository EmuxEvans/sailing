...
#define atom_cas_ptr(p, v, c)		atom_unix_cas_ptr((volatile void**)p, (void*)v, (const void*)c)
...
ZION_API void* atom_unix_cas_ptr(volatile void **mem, void *with, const void *cmp);
